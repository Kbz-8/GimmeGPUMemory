#ifndef GGM_DEVICE_ALLOCATOR_H
#define GGM_DEVICE_ALLOCATOR_H
...
namespace Ggm
{
	...
	class DeviceAllocator
	{
		public:
			...
			inline void AttachToDevice(VkDevice device, VkPhysicalDevice physical, VulkanFunctions functions) noexcept;
			...
			[[nodiscard]] inline MemoryBlock Allocate(VkDeviceSize size, VkDeviceSize alignment, std::int32_t memory_type_index, bool dedicated_chunk = false);
